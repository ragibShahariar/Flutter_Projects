                            ...
                            children: [
                              Container(
                                ...
                                child: DropdownButton(
                                  ...
                                  items: MobileBanking.values.map((value) {
                                    return DropdownMenuItem<MobileBanking>(
                                      value: value,
                              ...
                              Expanded(
                                child: TextField(
                                  controller: _mobileBankingTextController,
                                  decoration: InputDecoration(
                                    ...
                                    enabledBorder: OutlineInputBorder(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(20)),
                                      borderSide:
                                          BorderSide(color: Color(0xfffef9c6)),
                                    ),
                                    focusedBorder: OutlineInputBorder(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(20)),
                                      borderSide: BorderSide(
                                          color: Color(0xfff2e916), width: 2),
                                    ),
                                  ),
                                ),
                              ),
                            ...
                            children: [
                              Container(
                                ...
                                child: DropdownButton(
                                  ...
                                  items: CryptoWallets.values.map((value) {
                                    return DropdownMenuItem<CryptoWallets>(
                                      value: value,
                                      child: Text(value.name),
                                    );
                                  }).toList(),
                              ...
                              Expanded(
                                child: TextField(
                                  controller: _cryptoWalletsTextController,
                                  decoration: InputDecoration(
                                    hintText:
